...
<div class="landing">
    ...
    <div class="section section-even clear" style="background: url(<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>background1.png) no-repeat #fff; background-position: 85% 75%">
        <h1><?php echo __('Premium Features');?></h1>
        <div class="landing-container">
            <div class="col-1">
                <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>001.png" alt="<?php echo __('SUMMARIZE');?>" />
            </div>
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>icon1.png" alt="icon1" />
                    <h2><?php echo __('Review title');?></h2>
                </div>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php echo __('REVIEW ATTACHMENT');?></h2>
                </div>
            ...
            <div class="col-1">
                <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>002.png" alt="<?php echo __('ADD AN ATTACHMENT');?>" />
            </div>
        </div>
    </div>
    <div class="section section-even clear" style="background: url(<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>11-g.png) no-repeat #fff; background-position: 85% 75%">
        <div class="landing-container">
            <div class="col-1">
                <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>003.png" alt="<?php echo __('CUSTOMIZE COLOURS');?>" />
            </div>
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>11-icon.png" alt="icon11" />
                    <h2><?php echo __('COLOR CUSTOMIZATION');?></h2>
                </div>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php echo __('VOTER PERCENTAGE BY RATING');?></h2>
                </div>
            ...
            <div class="col-1">
                <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>004.png" alt="<?php echo __('REPRESENT GRAPHICALLY');?>" />
            </div>
        </div>
    </div>
    <div class="section section-even clear" style="background: url(<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>background1.png) no-repeat #fff; background-position: 85% 75%">
        <div class="landing-container">
            <div class="col-1">
                <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>02.png" alt="<?php echo __('MODAL WINDOW');?>" />
            </div>
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>icon1.png" alt="icon1" />
                    <h2><?php echo __('MODAL WINDOW');?></h2>
                </div>
    ...
    <div class="section section-odd clear" style="background: url(<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>background2.png) no-repeat #f1f1f1; background-position: 15% 100%">
        <div class="landing-container">
            ...
            <div class="col-1">
                <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>01.png" alt="<?php echo __('LOAD MORE');?>" />
            </div>
        </div>
    </div>
    <div class="section section-even clear" style="background: url(<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>background3.png) no-repeat #fff; background-position: 85% 100%">
        <div class="landing-container">
            <div class="col-1">
                <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>03.png" alt="<?php echo __('VOTE THE REVIEW');?>" />
            </div>
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>icon3.png" alt="icon3" />
                    <h2><?php echo __('VOTE THE REVIEW');?></h2>
                </div>
    ...
    <div class="section section-odd clear" style="background: url(<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>background4.png) no-repeat #f1f1f1; background-position: 15% 100%">
        <div class="landing-container">
            ...
            <div class="col-1">
                <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>04.png" alt="<?php echo __('NUMBER');?>" />
            </div>
        </div>
    </div>
    <div class="section section-even clear" style="background: url(<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>background5.png) no-repeat #fff; background-position: 85% 100%">
        <div class="landing-container">
            <div class="col-1">
                <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>05.png" alt="<?php echo __('FILTER BY RATING');?>" />
            </div>
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL?>icon5.png" alt="icon5" />
                    <h2><?php echo __('FILTER BY RATING');?></h2>
                </div>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php echo __('REPLY TO REVIEW');?></h2>
                </div>
            ...
            <div class="col-1">
                <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>06.png" alt="<?php echo __('REPLY TO REVIEW');?>" />
            </div>
        </div>
    </div>
    <div class="section section-even clear" style="background: url(<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>07-bg.png) no-repeat #fff; background-position: 85% 100%">
        <div class="landing-container">
            <div class="col-1">
                <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>07.png" alt="<?php echo __('MANUAL REVIEW APPROVAL');?>" />
            </div>
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL?>07-icon.png" alt="icon7" />
                    <h2><?php echo __('MANUAL REVIEW APPROVAL');?></h2>
                </div>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php echo __('ENABLE VOTE FOR ALL');?></h2>
                </div>
            ...
            <div class="col-1">
                <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>08.png" alt="<?php echo __('ENABLE VOTE FOR ALL');?>" />
            </div>
        </div>
    </div>
    <div class="section section-even clear" style="background: url(<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>09-bg.png) no-repeat #fff; background-position: 85% 100%">
        <div class="landing-container">
            <div class="col-1">
                <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>09.png" alt="<?php echo __('INAPPROPRIATE REVIEWS');?>" />
            </div>
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL?>09-icon.png" alt="icon-09" />
                    <h2><?php echo __('INAPPROPRIATE REVIEWS');?></h2>
                </div>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php echo __('FEATURED REVIEWS');?></h2>
                </div>
            ...
            <div class="col-1">
                <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>10.png" alt="<?php echo __('FEATURED REVIEWS');?>" />
            </div>
        </div>
    </div>
    <div class="section section-even clear" style="background: url(<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>11-bg.png) no-repeat #fff; background-position: 85% 100%">
        <div class="landing-container">
            <div class="col-1">
                <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>11.png" alt="<?php echo __('MORE DETAILS');?>" />
            </div>
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL?>11-icon.png" alt="icon-11" />
                    <h2><?php echo __('MORE DETAILS');?></h2>
                </div>
    ...
    <div class="section section-odd clear" style="background: url(<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>12-bg.png) no-repeat #f1f1f1; background-position: 15% 100%">
        <div class="landing-container">
            ...
            <div class="col-1">
                <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>12.png" alt="<?php echo __('REPORT');?>" />
            </div>
        </div>
    </div>
    <div class="section section-even clear" style="background: url(<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>13-bg.png) no-repeat #fff; background-position: 85% 100%">
        <div class="landing-container">
            <div class="col-1">
                <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>13.png" alt="<?php echo __('STOP REPLY');?>" />
            </div>
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL?>13-icon.png" alt="icon-13" />
                    <h2><?php echo __('STOP REPLY');?></h2>
                </div>
        ...
        <div class="landing-container">
            <div class="col-2">
                <div class="section-title">
                    ...
                    <h2><?php echo __('SINGLE REVIEW');?></h2>
                </div>
            ...
            <div class="col-1">
                <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>15.png" alt="<?php echo __('Single review');?>" />
            </div>
        </div>
    </div>
    <div class="section section-even clear" style="background: url(<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>16-bg.png) no-repeat #fff; background-position: 85% 100%">
        <div class="landing-container">
            <div class="col-1">
                <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL ?>16.png" alt="<?php echo __('EDIT REVIEWS');?>" />
            </div>
            <div class="col-2">
                <div class="section-title">
                    <img src="<?php echo YITH_YWAR_ASSETS_IMAGES_URL?>16-icon.png" alt="icon-16" />
                    <h2><?php echo __('EDIT REVIEWS');?></h2>
                </div>
