...
if ( !dokan_is_seller_has_order( dokan_get_current_user_id(), $order_id ) ) {
    echo '<div class="dokan-alert dokan-alert-danger">' . esc_html__( '¡Esto no es tuyo, lo juro!', 'dokan-lite' ) . '</div>';
    return;
}
...
<div class="dokan-clearfix">
        ...
        <div class="dokan-clearfix">
            <div class="" style="width:100%">
                <div class="dokan-panel dokan-panel-default">
                    <div class="dokan-panel-heading"><strong><?php printf( esc_html__( 'Pedido', 'dokan-lite' ) . '#%d', esc_attr( dokan_get_prop( $order, 'id' ) ) ); ?></strong> &rarr; <?php esc_html_e( 'Encargar artículos', 'dokan-lite' ); ?></div>
                        ...
                        ?>
                                <table cellpadding="0" cellspacing="0" class="dokan-table order-items">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="line_cost"><?php esc_html_e( 'Totales', 'dokan-lite' ); ?></th>
                                        </tr>
                                    </thead>
                                ...
                                if ( $coupons ) {
                                    ...
                                    <table class="dokan-table order-items">
                                        <tr>
                                            <th><?php esc_html_e( 'Cupones', 'dokan-lite' ); ?></th>
                                            <td>
            ...
            <div class="dokan-left dokan-order-billing-address">
                <div class="dokan-panel dokan-panel-default">
                    <div class="dokan-panel-heading"><strong><?php esc_html_e( 'Dirección de Envio', 'dokan-lite' ); ?></strong></div>
                    <div class="dokan-panel-body">
                        <?php
                            if ( $order->get_formatted_billing_address() ) {
                                echo wp_kses_post( $order->get_formatted_billing_address() );
                            } else {
                                esc_html_e( 'No se estableció ninguna dirección de facturación.', 'dokan-lite' );
                            }
                        ?>
                    </div>
                </div>
            ...
            <div class="dokan-left dokan-order-shipping-address">
                <div class="dokan-panel dokan-panel-default">
                    <div class="dokan-panel-heading"><strong><?php esc_html_e( 'Dirección de Envío', 'dokan-lite' ); ?></strong></div>
                    <div class="dokan-panel-body">
                        <?php
                            if ( $order->get_formatted_shipping_address() ) {
                                echo wp_kses_post( $order->get_formatted_shipping_address() );
                            } else {
                                esc_html_e( 'No se estableció la dirección de envío.', 'dokan-lite' );
                            }
                        ?>
                    </div>
                </div>
            ...
            <div class="" style="width: 100%">
                <div class="dokan-panel dokan-panel-default">
                    <div class="dokan-panel-heading"><strong><?php esc_html_e( 'Permiso de producto descargable', 'dokan-lite' ); ?></strong></div>
                    <div class="dokan-panel-body">
                        <?php
    ...
    <div class="dokan-w4 dokan-order-right-content">
        <div class="dokan-clearfix">
            <div class="" style="width:100%">
                <div class="dokan-panel dokan-panel-default">
                    <div class="dokan-panel-heading"><strong><?php esc_html_e( 'Detalles generales', 'dokan-lite' ); ?></strong></div>
                    <div class="dokan-panel-body general-details">
                        <ul class="list-unstyled order-status">
                            <li>
                                <span><?php esc_html_e( 'Estado de la orden:', 'dokan-lite' ); ?></span>
                                ...
                                <?php if ( current_user_can( 'dokan_manage_order' ) && dokan_get_option( 'order_status_change', 'dokan_selling', 'on' ) == 'on' && $order->get_status() !== 'cancelled' && $order->get_status() !== 'refunded' ) {?>
                                    <a href="#" class="dokan-edit-status"><small><?php esc_html_e( '&nbsp; Editar', 'dokan-lite' ); ?></small></a>
                                <?php } ?>
                            </li>
                            <?php if ( current_user_can( 'dokan_manage_order' ) ): ?>
                                <li class="dokan-hide">
                                    <form id="dokan-order-status-form" action="" method="post">
                                        ...
                                        <a href="#" class="dokan-btn dokan-btn-default dokan-btn-sm dokan-cancel-status"><?php esc_html_e( 'Cancelar', 'dokan-lite' ) ?></a>
                                    </form>
                                </li>
                            <?php endif ?>

                            <li>
                                <span><?php esc_html_e( 'Fecha de orden:', 'dokan-lite' ); ?></span>
                                <?php echo esc_html( dokan_get_date_created( $order ) ); ?>
                            </li>
                            <li class="earning-from-order">
                                <span><?php esc_html_e( 'Ganar con el pedido:', 'dokan-lite' ); ?></span>
                        ...
                        <ul class="list-unstyled customer-details">
                            <li>
                                <span><?php esc_html_e( 'Cliente:', 'dokan-lite' ); ?></span>
                                <?php
                            ...
                            <li>
                                <span><?php esc_html_e( 'Teléfono:', 'dokan-lite' ); ?></span>
                                <?php echo esc_html( get_post_meta( dokan_get_prop( $order, 'id' ), '_billing_phone', true ) ); ?>
                            </li>
                            <li>
                                <span><?php esc_html_e( 'IP del Cliente:', 'dokan-lite' ); ?></span>
                        ...
                        if ( get_option( 'woocommerce_enable_order_comments' ) != 'no' ) {
                            ...
                            if ( !empty( $customer_note ) ) {
                                ...
                                <div class="alert alert-success customer-note">
                                    <strong><?php esc_html_e( 'Nota del Cliente:', 'dokan-lite' ) ?></strong><br>
            ...
            <div class="" style="width:100%">
                <div class="dokan-panel dokan-panel-default">
                    <div class="dokan-panel-heading"><strong><?php esc_html_e( 'pedidos', 'dokan-lite' ); ?></strong></div>
                    <div class="dokan-panel-body" id="dokan-order-notes">
                        ...
                        if ( $notes ) {
                            foreach( $notes as $note ) {
                                ...
                                <li rel="<?php echo esc_attr( absint( $note->comment_ID ) ) ; ?>" class="<?php echo esc_attr( implode( ' ', $note_classes ) ); ?>">
                                    ...
                                    <p class="meta">
                                        <?php printf( esc_html__( 'añadido hace %s', 'dokan-lite' ), esc_textarea( human_time_diff( strtotime( $note->comment_date_gmt ), current_time( 'timestamp', 1 ) ) ) ); ?>
                                        <?php if ( current_user_can( 'dokan_manage_order_note' ) ): ?>
                                            <a href="#" class="delete_note"><?php esc_html_e( 'Borrar nota', 'dokan-lite' ); ?></a>
                                        <?php endif ?>
                                    </p>
                                </li>
                                <?php
                            ...
                            echo '<li>' . esc_html__( 'Aún no hay notas para este pedido..', 'dokan-lite' ) . '</li>';
                        }
                        ...
                        <div class="add_note">
                            <?php if ( current_user_can( 'dokan_manage_order_note' ) ): ?>
                                <h4><?php esc_html_e( 'Añadir la nota', 'dokan-lite' ); ?></h4>
                                    ...
                                    <div class="clearfix">
                                        <div class="order_note_type dokan-form-group">
                                            <select name="note_type" id="order_note_type" class="dokan-form-control">
                                                <option value="customer"><?php esc_html_e( 'Nota del cliente', 'dokan-lite' ); ?></option>
                                                <option value=""><?php esc_html_e( 'Nota privada', 'dokan-lite' ); ?></option>
                                            </select>
                                        </div>
                                        ...
                                        <input type="submit" name="add_order_note" class="add_note btn btn-sm btn-theme" value="<?php esc_attr_e( 'Añadir la nota', 'dokan-lite' ); ?>">
                                    </div>
                                </form>
                            <?php endif; ?>
                            ...
                            <div class="clearfix dokan-form-group" style="margin-top: 10px;">
                                ...
                                <input type="button" id="dokan-add-tracking-number" name="add_tracking_number" class="dokan-btn dokan-btn-success" value="<?php esc_attr_e( 'El número de rastreo', 'dokan-lite' ); ?>">

                                <form id="add-shipping-tracking-form" method="post" class="dokan-hide" style="margin-top: 10px;">
                                    <div class="dokan-form-group">
                                        <label class="dokan-control-label"><?php esc_html_e( 'Nombre / URL del proveedor de envío', 'dokan-lite' ); ?></label>
                                        <input type="text" name="shipping_provider" id="shipping_provider" class="dokan-form-control" value="">
                                    </div>

                                    <div class="dokan-form-group">
                                        <label class="dokan-control-label"><?php esc_html_e( 'El número de rastreo', 'dokan-lite' ); ?></label>
                                        <input type="text" name="tracking_number" id="tracking_number" class="dokan-form-control" value="">
                                    </div>

                                    <div class="dokan-form-group">
                                        <label class="dokan-control-label"><?php esc_html_e( 'Fecha de envío', 'dokan-lite' ); ?></label>
                                    ...
                                    <div class="dokan-form-group">
                                        <input id="add-tracking-details" type="button" class="btn btn-primary" value="<?php esc_attr_e('Agregar detalles de seguimiento', 'dokan-lite' );?>">
                                        <button type="button" class="btn btn-default" id="dokan-cancel-tracking-note"><?php esc_html_e( 'Cerrar', 'dokan-lite' );?></button>
                                    </div>
                                </form>
                            </div>
                        </div> <!-- .add_note -->
