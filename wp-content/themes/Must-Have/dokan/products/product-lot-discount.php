<?php if ( isset( $is_enable_op_discount['product-discount'] ) && $is_enable_op_discount['product-discount'] == 'product-discount' ) : ?>
    <div class="dokan-discount-options dokan-edit-row dokan-clearfix">
        <div class="dokan-section-heading" data-togglehandler="dokan_discount_options">
            <h2><i class="fa fa-gift"></i> <?php _e( 'Opciones de descuento', 'dokan' ); ?></h2>
            <p><?php _e( 'Establezca su descuento para este producto ', 'dokan' ) ?></p>
        ...
        <div class="dokan-section-content">
            ...
            <div class="show_if_needs_lot_discount <?php echo ( $_is_lot_discount=='yes') ? '' : 'dokan-hide'; ?>">
                <div class="content-half-part">
                    <label class="dokan-form-label" for="_lot_discount_quantity"><?php _e('Cantidad mínima', 'dokan');?></label>
                ...
                <div class="dokan-form-group content-half-part">
                    <label class="dokan-form-label" for="_lot_discount_amount"><?php _e('Descuento %', 'dokan');?></label>
                    <div class="dokan-input-group">
                        <input id="_lot_discount_amount" value="<?php echo $_lot_discount_amount; ?>" name="_lot_discount_amount" placeholder="<?php _e( 'Porcentaje', 'dokan' ); ?>" class="dokan-form-control" type="number" min="0" max="100">
