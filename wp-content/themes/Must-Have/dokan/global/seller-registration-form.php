...
<div class="show_if_seller" style="<?php echo esc_attr( $role_style ); ?>">
    ...
    <div class="split-row form-row-wide">
        <p class="form-row form-group">
            <label for="first-name"><?php esc_html_e( 'Nombre', 'dokan-lite' ); ?> <span class="required">*</span></label>
        ...
        <p class="form-row form-group">
            <label for="last-name"><?php esc_html_e( 'Apellido', 'dokan-lite' ); ?> <span class="required">*</span></label>
    ...
    <p class="form-row form-group form-row-wide">
        <label for="company-name"><?php esc_html_e( 'Nombre de la tienda', 'dokan-lite' ); ?> <span class="required">*</span></label>
    ...
    <p class="form-row form-group form-row-wide">
        <label for="seller-url" class="pull-left"><?php esc_html_e( 'URL de la tienda', 'dokan-lite' ); ?> <span class="required">*</span></label>
    ...
    <p class="form-row form-group form-row-wide">
        <label for="shop-phone"><?php esc_html_e( 'Número de teléfono', 'dokan-lite' ); ?><span class="required">*</span></label>
    ...
    if ( 'on' === $show_terms_condition && $terms_condition_url ) { ?>
        <p class="form-row form-group form-row-wide">
            ...
            <label style="display: inline" for="tc_agree"><?php echo wp_kses_post( sprintf( __( 'He leído y acepto las <a target="_blank" href="%s"> Términos &amp; Condiciones </a>.', 'dokan-lite' ), esc_url( $terms_condition_url ) ) ); ?></label>
        </p>
    <?php }
