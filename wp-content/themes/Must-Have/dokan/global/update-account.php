...
<h2><?php _e( 'Actualizar cuenta a proveedor', 'dokan' ); ?></h2>
<form method="post" action="" class="register">
    ...
    <div class="dokan-become-seller">
        ...
        <div class="split-row form-row-wide">
            ...
            <p class="form-row form-group">
                <label for="last-name"><?php _e( 'Apellido', 'dokan' ); ?> <span class="required">*</span></label>
        ...
        if ( $show_toc == 'on' ) {
            ...
            if ( $toc_page_id != -1 ) {
                ...
                <p class="form-row form-group form-row-wide">
                    ...
                    <label style="display: inline" for="tc_agree"><?php echo sprintf( __( 'he leído y estoy de acuerdo con <a target="_blank" href="%s">Términos &amp; Condiciones</a>.', 'dokan' ), $toc_page_url ); ?></label>
                </p>
            <?php } ?>
        <?php } ?>
        ...
        <?php wp_nonce_field( 'account_migration', 'dokan_nonce' ); ?>
            ...
            <input type="submit" class="dokan-btn dokan-btn-default" name="dokan_migration" value="<?php _e( 'Conviértete en vendedor ', 'dokan' ); ?>" />
        </p>
    </div>
</form>
