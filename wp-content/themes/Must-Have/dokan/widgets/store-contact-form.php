...
<form id="dokan-form-contact-seller" action="" method="post" class="seller-form clearfix">
    ...
    <ul>
        <li class="dokan-form-group">
            <input type="text" name="name" value="<?php echo esc_attr( $username ); ?>" placeholder="<?php esc_attr_e( 'Tu nombre', 'dokan-lite' ); ?>" class="dokan-form-control" minlength="5" required="required">
        </li>
        <li class="dokan-form-group">
        ...
        <li class="dokan-form-group">
            <textarea  name="message" maxlength="1000" cols="25" rows="6" value="" placeholder="<?php esc_attr_e( 'Escribe tu mensaje...', 'dokan-lite' ); ?>" class="dokan-form-control" required="required"></textarea>
        </li>
    </ul>
    ...
    <input type="submit" name="store_message_send" value="<?php esc_attr_e( 'Enviar mensaje', 'dokan-lite' ); ?>" class="dokan-right dokan-btn dokan-btn-theme">
</form>
