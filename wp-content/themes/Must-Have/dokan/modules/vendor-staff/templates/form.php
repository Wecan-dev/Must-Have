    ...
    <form method="post" action="" class="dokan-form-horizontal vendor-staff register">
        ...
        <div class="dokan-form-group">
            ...
            <div class="dokan-w5 dokan-text-left">
                <input id="first_name" name="first_name" required value="<?php echo esc_attr( $first_name ); ?>" placeholder="<?php _e( 'Nombre', 'dokan' ); ?>" class="dokan-form-control input-md" type="text">
            </div>
        </div>
