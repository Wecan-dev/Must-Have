        ...
        <header class="dokan-dashboard-header">
            <span class="left-header-content">
                <h1 class="entry-title">
                    <?php _e( 'Personal', 'dokan' ); ?>

                    <span class="left-header-content dokan-right">
                        <a href="<?php echo add_query_arg( array( 'view' => 'add_staffs' ), dokan_get_navigation_url( 'staffs' ) ); ?>" class="dokan-btn dokan-btn-theme dokan-right"><i class="fa fa-user">&nbsp;</i> <?php _e( 'Añadir nuevo personal', 'dokan' ); ?></a>
                    </span>
                </h1>
            </span>
        ...
        <article class="dokan-staffs-area">
            ...
            <?php
                if ( isset( $_GET['message'] ) && $_GET['message'] == 'deleted' ) {
                    dokan_get_template_part('global/dokan-success', '', array( 'deleted' => true, 'message' => __( 'Personal eliminado correctamente', 'dokan' ) ) );
                }
            ?>
            ...
            <?php
                ...
                if ( count( $staffs['staffs'] ) > 0 ) {
                    ...
                    <table class="dokan-table dokan-table-striped vendor-staff-table">
                        <thead>
                            <tr>
                                <th><?php _e( 'Nombre', 'dokan' ); ?></th>
                                <th><?php _e( 'Email', 'dokan' ); ?></th>
                                <th><?php _e( 'Teléfono', 'dokan' ); ?></th>
                                <th><?php _e( 'Fecha de registro', 'dokan' ); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                                ...
                                <tr >
                                    <td>
                                        ...
                                        <div class="row-actions">
                                            ...
                                            <?php if ( current_user_can( 'seller' ) ): ?>
                                                <span class="delete"><a  href="<?php echo $delete_url; ?>"  onclick="return confirm('<?php esc_attr_e( 'Are you sure want to delete', 'dokan' ); ?>');"><?php _e( 'Borrar', 'dokan' ); ?></a> | </span>
                                            <?php endif ?>

                                            <?php if ( current_user_can( 'seller' ) ): ?>
                                                <span class="permission"><a  href="<?php echo $manage_permission_url; ?>" ><?php _e( 'Administrar permisos', 'dokan' ); ?></a></span>
                                            <?php endif ?>
                                        </div>
                                    </td>
                ...
                <?php } else { ?>
                    ...
                    <div class="dokan-error">
                        <?php _e( 'No se encontró personal', 'dokan' ); ?>
                    </div>
